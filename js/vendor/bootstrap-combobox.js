...
/* =>>=>=>=
 * CHANGED VERSION
 * Copyright 2020 Matthis Kruse
 *
 * same license as above
 */

// Changes I do here are simply to replace the combobox button with literally a button.
// The original version uses a span hacked together which makes styling rather difficult
...
(function( $ ) {
  ...
  * ================================ */
  ...
  , toggle: function () {
    if (!this.disabled) {
      if (false && this.$container.hasClass('combobox-selected')) {
        this.clearTarget();
        this.triggerChange();
        this.clearElement();
      } else {
